CLASS zcm_be_requests DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF lrequest_decline,
        msgid TYPE symsgid VALUE 'ZBE_MLREQUEST',
        msgno TYPE symsgno VALUE '001',
        attr1 TYPE scx_attrname VALUE 'ApplicationComment',
...
CLASS zcm_be_requests IMPLEMENTATION.
